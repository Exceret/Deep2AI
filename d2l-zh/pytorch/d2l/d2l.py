...
def load_data_wiki2(batch_size, max_len):
    """加载WikiText-2数据集"""
    num_workers = get_dataloader_workers()
    paragraphs = _read_wiki(
        data_dir=r"/data/home/yyx/Project/Deep2AI/d2l-zh/pytorch/chapter_natural-language-processing-pretraining/train-00000-of-00001.parquet"
    )
